...
"GOOGLE_CLIENT_ID",
"647237772956-i7d79iftllabu88t4o06jb117q6tmvtp.apps.googleusercontent.com"
)

GOOGLE_CLIENT_SECRET = os.getenv(
"GOOGLE_CLIENT_SECRET",
"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"
)
...
"JWT_SECRET",
"resume-ranker-super-secret-key-change-in-prod"
)
...
return RedirectResponse(
    f"{frontend_url}/?token={jwt_token}&name={name}&email={email}"
)
```
